(function () {
	...
	if (has_values) {
		...
		setValue(mi_fs, first_source);
		setValue(mi_fm, first_medium);
		setValue(mi_ft, first_term);
		setValue(mi_fc, first_content);
		setValue(mi_fn, first_campaign);

		setValue(mi_ls, last_source);
		setValue(mi_lm, last_medium);
		setValue(mi_lt, last_term);
		setValue(mi_lc, last_content);
		setValue(mi_ln, last_campaign);
