/////////////////////////////////////////////////////////
// tracking.js v2.7 | midigitalagency.com
/////////////////////////////////////////////////////////
...
var miSetCookie = function(cname, cvalue) {
	...
	now.setTime(time);
	document.cookie = cname + '=' + cvalue + '; expires=' + now.toUTCString() + '; domain=.midigitalagency.com; path=/';
}
...
var miGetUtms = function() {
	...
	} else if (referrer_source && referrer_source.indexOf('.midigitalagency.com') == -1) {
	...
	} else if (referrer_source.indexOf('.midigitalagency.com') == -1) {
	...
	if (has_values) {
		...
		if (first_source.indexOf('www.bing.com') != -1) first_source = "bing";
		if (last_source.indexOf('www.bing.com') != -1) last_source = "bing";
		...
		jQuery('iframe').each(function() {
			...
			var questamp = "?";
			if (iframeurl && iframeurl.indexOf("go.midigitalagency.com") > -1) {
